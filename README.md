...
# Table of contents:
 ...
 - [How to interpret the generated data](#Data)
...
A detailed explanation of the parameters needed to run the simulations is given in [Parameters](docs/Parameter.md).
...
For examples on how to use and analyze data generated by **MagneticFriction**, see [Examples](docs/Examples.md). These examples also act as a small demo for the software. They also contain valuable information and tools to reproduce most of the data presented in [1].
